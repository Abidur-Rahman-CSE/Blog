                    ...
                    <div class="col-xl-4 col-xxl-6 col-lg-6 col-sm-6 ">
                        <div class="card mb-3">
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                ...
                                {{-- <a href="javascript:void()" class="btn float-right">

                            </a> --}}
                                <div class="justify-content-end">
                                    {{-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" style="color: gray; width:2em; height:2em;"
                                        class="w-6 h-6">
                                    ...
                                    {{-- <form action="{{ route('blogDelete',$blog->id)  }}" method="post">
                                        ...
                                        <svg onclick="submitDelete('blogDelete{{ $blog->id }}')" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        ...
                                        <button type="submit" id="blogDelete{{ $blog->id }}" class="btn btn-danger" style="display: none;">Submit</button>
                                    </form> --}}
