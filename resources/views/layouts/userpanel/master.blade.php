...
<head>
    ...
    <!-- favicon -->
    <link rel="icon" sizes="16x16" href="{{ asset('userpanelAssets/img/favicon.png') }}">
    ...
    <!-- CSS Plugins -->
    <link rel="stylesheet" href="{{ asset('userpanelAssets/css/all.css') }}">
    <link rel="stylesheet" href="{{ asset('userpanelAssets/css/elegant-font-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('userpanelAssets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('userpanelAssets/css/owl.carousel.css') }}">
    <!-- main style -->
    <link rel="stylesheet" href="{{ asset('userpanelAssets/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('userpanelAssets/css/custom.css') }}">
</head>
...
<body>
    ...
    <script src="{{ asset('userpanelAssets/js/jquery-3.5.0.min.js') }}"></script>
    <script src="{{ asset('userpanelAssets/js/popper.min.js') }}"></script>
    <script src="{{ asset('userpanelAssets/js/bootstrap.min.js') }}"></script>

    <!-- JS Plugins  -->
    <script src="{{ asset('userpanelAssets/js/ajax-contact.js') }}"></script>
    <script src="{{ asset('userpanelAssets/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('userpanelAssets/js/switch.js') }}"></script>

    <!-- JS main  -->
    <script src="{{ asset('userpanelAssets/js/main.js') }}"></script>

    @yield('footer_js')
</body>


<!-- Mirrored from noonpost.netlify.app/html/template/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 May 2021 04:14:26 GMT -->
</html>
